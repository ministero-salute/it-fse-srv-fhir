package it.finanze.sanita.fse2.ms.srvfhirmappingmanager.logging;
...
import it.finanze.sanita.fse2.ms.srvfhirmappingmanager.enums.ILogEnum;
...
public class ElasticLoggerHelper implements Serializable {
	 ...
	 * Serial Version UID 
	 */
	private static final long serialVersionUID = 2523243378194602748L;

	
	static Logger log = LoggerFactory.getLogger("elastic-logger"); 
